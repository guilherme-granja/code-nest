// Ícones inline (sem font externa — evita dependência de rede/ligature que já quebrou 2x). Paths do Feather Icons (MIT).
...
export function IconTerminal({ className }: Props) {
  return (
    <svg {...base} className={className}>
...
export function IconShuffle({ className }: Props) {
  return (
    <svg {...base} className={className}>
